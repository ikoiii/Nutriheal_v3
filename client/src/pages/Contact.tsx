    ...
    >
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="p-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition transform hover:-translate-y-1">
            ...
            <div className="flex justify-center space-x-5 mt-2">
              <a
                href="#"
                className="text-gray-600 hover:text-green-600 transition text-xl"
              >
        ...
        <div className="mt-16 text-sm text-gray-500">
          <p>
            © 2025 <span className="font-semibold text-green-700">Nutri</span>
            <span className="font-semibold text-gray-900">Heal</span>. Semua hak
            dilindungi.
          </p>
        </div>
      </div>
